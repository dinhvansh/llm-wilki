...
class Diagram(Base):
    ...
    flow_document: Mapped[dict] = mapped_column(JSON, default=dict)
...
class RuntimeConfig(Base):
    ...
    answer_api_key: Mapped[str] = mapped_column(Text, nullable=False, default="")
    ...
    ingest_api_key: Mapped[str] = mapped_column(Text, nullable=False, default="")
